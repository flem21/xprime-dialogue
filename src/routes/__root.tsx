  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <Link to="/" className="mt-6 inline-block rounded-full bg-foreground px-5 py-2 text-sm text-background">Go home</Link>
      </div>
    </div>
  );
}
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "xPrime — Trade Injective in plain English" },
      { name: "description", content: "An AI-native trading console for Injective. Chat your intent, execute on-chain." },
    ],
    links: [
